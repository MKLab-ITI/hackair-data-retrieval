...
/**
 * Class containing code for converting an image's white background to be transparent, adapted with minor changes from
 * StackOverflow thread "How to make a color transparent in a BufferedImage and save as PNG"
 * (http://stackoverflow.com/questions/665406/how-to-make-a-color-transparen...).
 */
public class ImageTransparency {
	/**
	 * Main function for converting image at provided path/file name to have transparent background.
	 *
	 * @param arguments
	 *            Command-line arguments: only one argument is required with the first (required) argument being the
	 *            path/name of the source image and the second (optional) argument being the path/name of the
	 *            destination file.
	 */
	public static void main(final String[] arguments) throws Exception {
		...
		final String outputFileName = arguments.length > 1 ? arguments[1]
